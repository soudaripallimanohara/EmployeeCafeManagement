...
namespace EmployeeCafeManagement.Api.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IEnumerable<EmployeeCafeDto>> GetEmployees([FromQuery] Guid? cafeId)
        {
            IEnumerable< EmployeeCafeDto> employees = await _sender.Send(new GetEmployeesByCafeQuery(cafeId));
            return employees;
        }
