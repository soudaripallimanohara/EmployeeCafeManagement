...
namespace EmployeeCafeManagement.Infrastructure.Repositorys
{
    public class EmployeeRepository : IEmployeeRepository
    {
        ...
        public async Task<IEnumerable<EmployeeCafeDto>> GetEmployeesAsync(string? cafe)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(cafe))
                    employees = employees.Where(e => e.EmployeeCafe.Cafe.Name == cafe);
        ...
        {   
            ...
            int dateCompare = DateTime.Compare((DateTime)employDto.StartDate, DateTime.Today);
        ...
        { 
            ...
            int dateCompare = DateTime.Compare((DateTime)startDate, DateTime.Today);
